...
PDB = {
    ...
    MUTATION_URL: SERVERURL + "/server/api.php?taskid=10",
    CONSERVATION_URL: SERVERURL + "/server/api.php?taskid=11",
    ...
    GROUP_COUNT:40, GROUP_MAIN:0, GROUP_HET:1, GROUP_WATER:2,GROUP_LABEL:3,GROUP_INFO:4,
	...
	GROUP_MAP:34,GROUP_MENU_OUTBALL:35,GROUP_BOX_HELPER:36,GROUP_AXIS:37,GROUP_MENU_EXPORT:38,GROUP_MENU_SPEECH:39,
