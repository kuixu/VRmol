...
w3m.tool = {
    ...
    // [ id, xyz, color, tan, 4:normal, 5:binormal, 6:turnover ]
		...
		if(PDB.CLENGTH>0){			
			if(tempPathArray.length>0){
				PDB.cubeData.path.push(tempPathArray);
				PDB.cubeData.ids.push(tempIdArray);
				PDB.cubeData.binormals.push(tempBinormalsArray);
				PDB.cubeData.normals.push(tempNormalsArray);
				PDB.cubeData.tangents.push(tempTangentsArray);
